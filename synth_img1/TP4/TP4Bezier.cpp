...
//compilation en local par :
//  g++ -g -Wall -std=c++11 TP4Bezier.cpp -I glew\include -I freeglut\include -L glew\lib -L freeglut\lib -lopengl32 -lglu32 -lfreeglut -lglew32 -o TP4
